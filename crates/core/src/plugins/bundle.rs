...
//!
//! - `ryuzi-plugin.toml` — the [`PluginManifest`](ryuzi_plugin_sdk::PluginManifest)
//!   (TOML, hand-authored by the plugin publisher).
//! - the component file the manifest's `[component].file` field names (e.g.
//!   `acme_connector.wasm`).
...
//!    `ryuzi-plugin.toml` through [`PluginManifest::from_toml`] — both
