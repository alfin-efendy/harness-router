...
fn make_builder() -> Builder<tauri::Wry> {
    Builder::<tauri::Wry>::new()
        .commands(collect_commands![
            ...
            agent_cmd::export_agent,
            agent_cmd::import_agent,
            agent_cmd::save_agent_bundle,
            agent_cmd::read_agent_bundle,
            ...
            pets_cmd::list_pet_manifest,
            pets_cmd::download_pet,
            pets_cmd::get_pet_sprite,
            ...
            apps_cmd::begin_mcp_connect,
            apps_cmd::complete_mcp_connect,
            apps_cmd::disconnect_mcp,
            apps_cmd::list_manual_mcp_oauth_clients,
            apps_cmd::set_manual_mcp_oauth_client,
            apps_cmd::delete_manual_mcp_oauth_client,
            fsview_cmd::list_dir,
            ...
            connections_cmd::list_installed_providers,
            connections_cmd::install_provider,
            connections_cmd::uninstall_provider,
            connections_cmd::list_custom_providers,
            connections_cmd::add_custom_provider,
            ...
            native_cmd::global_command_read,
            native_cmd::global_command_create,
            native_cmd::global_command_update,
            native_cmd::global_command_delete,
            ...
            plugins_cmd::plugin_profile_begin_device_flow,
            plugins_cmd::plugin_profile_poll_device_flow,
            plugins_cmd::plugin_profile_disconnect,
            plugins_cmd::plugin_profile_begin_pkce,
            plugins_cmd::plugin_profile_complete_pkce,
            ...
            plugins_cmd::component_bootstrap_status,
